    ...
    def get_ui_elements(
        ...
        if isinstance(component, LED):
            ...
            elements.extend([
                ...
                RpiFlask.get_range(component.id, True, int(component.wheel_min_speed / 2.0), int(component.wheel_max_speed / 2.0), 1, True, True, rest_host, rest_port, component.set_speed_differential),
            ])
        else:
